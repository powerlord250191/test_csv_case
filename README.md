...
После этого можно запускать приложение в терминале командой - youtube-metrics --files data/stats1.csv data/stats2.csv --report clickbait.
...
Процент покрытия кода тестами при проверке через pytest cov:
